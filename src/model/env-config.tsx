...
const Production: Env = {
  ...
  codePushDeploymentKey: Platform.select({
    ios: '7b2MFp43hQvaP4FaXWAOWaIw3ZT-080db430-e919-421b-b0c5-16a7302cb692',
    android: 'fZVLXwHCTmBuw-DVYjuncuOgsSqz080db430-e919-421b-b0c5-16a7302cb692'
  }),
};
...
const Staging: Env = Object.assign({}, Production, {
  ...
  codePushDeploymentKey: Platform.select({
    ios: '8qEtHU9fjZjlJgus1D3pNJG5XzAl080db430-e919-421b-b0c5-16a7302cb692',
    android: 'gC3NWoSStXLPyBsSCFMBZ_a8u9Tw080db430-e919-421b-b0c5-16a7302cb692'
  }),
});
