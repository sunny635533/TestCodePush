...
let TransportAccountScreen = class TransportAccountScreen extends base_component_1.BaseComponent {
    constructor(props) {
        ...
        this.transitInfoStatService = new impl_1.TransitInfoStatServiceImpl(this.appContext.app.webService, this.appContext.app.env);
        const date = new Date();
    ...
    getTransitInfoStat() {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {
                ...
                userId: this.appContext.app.userId,
            };
    ...
    render() {
        ...
        return (React.createElement(react_native_1.View, { style: styles.flex },
            React.createElement(header_1.NavHeaderWithBack, { backAction: this.backToNative, middleView: this.headerMiddView() }),
