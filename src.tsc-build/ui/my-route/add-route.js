...
let AddRouteScreen = class AddRouteScreen extends base_component_1.BaseComponent {
    ...
    getCityData() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.appContext.app.interaction.blockAndWaitFor(this.myRouteService.getCityInfoList(), { kind: 0 });
            let pArr = [];
            if (result.success) {
    ...
    getGoodTyps() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.appContext.app.interaction.blockAndWaitFor(this.myRouteService.getGoodTypesList(), { kind: 0 });
            if (result.success) {
    ...
    addRoute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.appContext.app.interaction.blockAndWaitFor(this.myRouteService.addRoute(params));
            if (result.success) {
...
function AddRouteItem(props) {
    return (React.createElement(react_native_1.TouchableOpacity, { style: styles.addRouteItem, activeOpacity: 0.7, onPress: props.action },
        ...
        React.createElement(react_native_1.Text, { style: styles.description }, props.description),
